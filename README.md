...
2. https://drive.google.com/drive/folders/1YI4FS6-1Uhkf-AGb-F_LUn8wcb2wpNEu?usp=drive_link
...
3. Sau khi chạy file này xong <img width="121" height="34" alt="image" src="https://github.com/user-attachments/assets/c7b1cd0d-751e-4541-a6a7-7b23a81e2a52" />
...
## 🛠 Yêu Cầu Hệ Thống & Cấu Hình Chi Tiết

### 1. Phiên bản phần mềm sử dụng (Software Versions)

Để dự án hoạt động chính xác, vui lòng sử dụng các phiên bản sau:

- **Framework:** .NET SDK 10.0
- **Cơ sở dữ liệu:** SQL Server 2019 trở lên (hoặc SQL Server Express)
- **Thư viện ORM:** Entity Framework Core 10.0.7
- **Công cụ phát triển:** Visual Studio 2022 (v17.10+) hoặc VS Code
